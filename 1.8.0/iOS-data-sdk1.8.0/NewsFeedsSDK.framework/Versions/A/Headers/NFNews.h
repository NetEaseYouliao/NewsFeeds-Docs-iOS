 ...
 * 新闻的不感兴趣的内容负反馈model
 */
@interface NFFeedBackInfo: NSObject
...
//广告位类型：0代表新闻列表  1代表轮播图  2代表新闻详情  3代表相关推荐
...
//新闻类型，文章/图集/视频/小视频  article/picset/video/svideo
...
//不感兴趣的分类
@property (nonatomic, strong)   NSArray <NFFeedBackInfo *>*feedbacks;
