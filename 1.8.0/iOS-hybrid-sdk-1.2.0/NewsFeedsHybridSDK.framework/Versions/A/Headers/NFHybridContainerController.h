...
@protocol NFHybridContainerCustomNavigationBarDelegate <NSObject>

@optional
- (void)hybridContainerCustomNavLeftItemClicked;
- (void)hybridContainerCustomNavRightItemClicked;
...
@property (weak, nonatomic) id<NFHybridContainerCustomNavigationBarDelegate> customNavigationBarDelegate;
